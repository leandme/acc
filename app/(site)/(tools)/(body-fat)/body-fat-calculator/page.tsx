...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Calculate body fat percentage with the U.S. Navy method using height and circumference measurements. Includes category scoring, interpretation bar, and detailed guidance.",
