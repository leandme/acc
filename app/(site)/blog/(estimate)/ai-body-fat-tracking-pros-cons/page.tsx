      ...
      <GuideHero
        ...
        image={
          <figure className="max-w-3xl">
            <Image
              src="/blog/how-ai-body-fat-estimation-works.webp"
      ...
      <section className="mx-auto mt-16 lg:mt-24 max-w-3xl px-6 pb-20 [&>div+div]:mt-20 lg:[&>div+div]:mt-40">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            ...
            <a className="text-primary underline" href="/blog/body-fat-estimation-methods">
              Common Body Fat Estimation Methods Explained
            </a>{" "}
            and{" "}
            <a className="text-primary underline" href="/blog/how-accurate-is-ai-body-fat-estimation">
