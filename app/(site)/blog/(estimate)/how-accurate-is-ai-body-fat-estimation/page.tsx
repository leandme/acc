          ...
          compares to other at-home methods, and how to use it correctly.
                                            ...
                                            image={
                                              <figure className="max-w-3xl">
                                                <Image
  src="/blog/how-accurate-is-ai-body-fat-estimation.webp"
      ...
      <section className="mx-auto max-w-3xl px-6 pb-20 [&>div+div]:mt-20 lg:[&>div+div]:mt-40">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            ...
            <a className="text-primary underline" href="/blog/how-to-take-photos-for-body-fat-estimation">How to Take Photos for Body Fat Estimation</a>{" "}
