      ...
      <GuideHero
        ...
        image={
          <figure className="max-w-3xl">
            <Image
  src="/blog/estimate-body-fat-percentage-from-photo.webp"
      ...
      <section className="mx-auto max-w-3xl px-6 pb-20">
        ...
        <div className="mt-20 lg:mt-40 space-y-4">
          ...
          <figure className="rounded-2xl border bg-white p-4">
            <Image
  src="/blog/what-does-body-fat-percentage-look-like.webp"
        ...
        <References
          ...
          references={[
            ...
            },
            {
              ...
              href: "/blog/what-does-body-fat-percentage-look-like",
            },
            {
