      ...
      and choose tracking methods that actually help you over time.
                                      ...
                                      image={
                                        <figure className="max-w-3xl">
                                          <Image
  src="/blog/how-to-calculate-your-body-fat-percentage-at-home.webp"
...
<section className="space-y-12">
  ...
  <div className="space-y-4">
    ...
    <p className="text-gray-700 text-lg leading-relaxed">
      ...
      it <a className="text-primary underline" href="/blog/how-ai-body-fat-estimation-works">estimates body fat by analyzing how fat appears visually</a> across
