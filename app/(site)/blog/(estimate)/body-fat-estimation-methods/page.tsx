          ...
          when each one makes sense.
                                                  ...
                                                  image={
                                                    <figure className="max-w-3xl">
                                                      <Image
  src="/blog/body-fat-estimation-methods.webp"
      ...
      <section className="mx-auto max-w-3xl px-6 pb-20 [&>div+div]:mt-20 lg:[&>div+div]:mt-40">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            ...
            <a className="text-primary underline" href="/blog/how-accurate-are-smart-scales">How Accurate Are Smart Scales?</a>.
          </p>
...
<GuideStandardReferences slug="body-fat-estimation-methods" />

<MoreArticles
            currentSlug="body-fat-estimation-methods"
            basePath="/blog"
            articles={[
                {
