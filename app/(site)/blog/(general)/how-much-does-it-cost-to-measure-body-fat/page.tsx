      ...
      <GuideHero
        ...
        image={
          <figure className="max-w-3xl">
            <Image
  src="/blog/body-fat-measurement-cost.webp"
      ...
      <section className="mx-auto max-w-3xl px-6 pb-20 [&>div+div]:mt-20 lg:[&>div+div]:mt-40">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            ...
            <a className="text-primary underline" href="/blog/best-way-to-measure-body-fat-at-home">The 3 Best Ways to Measure Your Body Fat % at Home</a>.
          </p>
        </div>
