      ...
      <div className="mx-auto max-w-6xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <h2 className="text-3xl lg:text-4xl font-semibold mb-4">
            ...
            estimates their body fat percentage. Instead of relying on formulas or manual
            measurements,  uses computer vision to evaluate visible body composition,
            ...
            is by focuses on how your body looks, making it especially useful for
